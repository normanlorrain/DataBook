...
% Some Serif, Sans Serif combinations
...
% \setsansfont[]{Gill Sans MT}  % or Arial Black 
\setmonofont[]{Consolas}

%\titleformat{<command>}[<shape>]{<format>}{<label>}{<sep>}{<before-code>}[<after-code>]
\titleformat{\section}[block]
  {\hspace{-5em}\normalfont\sffamily\Large\bfseries\color{darkolivegreen}}
  {\thesection}{0em}{}
...
\renewcommand{\includegraphics}[2][width=0.5\textwidth]
{
  \begin{center}
